...
public class Facade
{
    AbstractFactory firstTeamFactory;
    AbstractFactory secondTeamFactory;
    private int countInitial;
    public Facade(AbstractFactory firstTeam, AbstractFactory secondTeam, int count)
    {
        firstTeamFactory = firstTeam;
        secondTeamFactory = secondTeam;
        countInitial = count;
    }
    public void InitialWar()
    {
